...
import com.jianzhiniu.adapter.CheckAdapter;
...
public class CustomMultiChoiceDialog extends Dialog {
	...
	public static class Builder {
		...
		public CustomMultiChoiceDialog create() {
			...
			final CustomMultiChoiceDialog dialog = new CustomMultiChoiceDialog(context, R.style.alert_dialog);
			...
			if (positiveButtonText != null) {
				...
				positiveButton.setTextColor(context.getResources().getColor(R.color.top_blue));
