...
public class Dialogadapter2 extends BaseAdapter {
	...
	public Dialogadapter2(List<Map<String, String>> list, Context context){
		this.list = list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		hoder = new ViewHoder();
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(R.layout.selectview_item2, null);
		...
		hoder.textView.setText(list.get(position).get("title"));
		return convertView;
	}
