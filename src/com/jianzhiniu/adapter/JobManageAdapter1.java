...
public class JobManageAdapter1 extends BaseAdapter {
	...
	public JobManageAdapter1(List<Map<String, String>> list, Context context){
		this.list = list;
...
//		hoder.state.setText(R.string.xj);
//		hoder.state.setTextColor(context.getResources().getColor(R.color.purple));
